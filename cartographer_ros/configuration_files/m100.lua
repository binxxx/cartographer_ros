...
TRAJECTORY_BUILDER_3D_ESKF.scans_per_accumulation = 20
...
TRAJECTORY_BUILDER_3D_ESKF.submaps.initial_map_file_name = "/home/binx/Documents/CMU/rlm_project/Downloads/data/initial_map.bt"
TRAJECTORY_BUILDER_3D_ESKF.submaps.initial_map_resolution = 0.1
TRAJECTORY_BUILDER_3D_ESKF.submaps.distance_map_range = 15.0
TRAJECTORY_BUILDER_3D_ESKF.eskf.sigma_accelerometer = 1.0
TRAJECTORY_BUILDER_3D_ESKF.eskf.sigma_gyroscope = 0.1
TRAJECTORY_BUILDER_3D_ESKF.eskf.imu_enabled = false
TRAJECTORY_BUILDER_3D_ESKF.eskf.imu_frequency = 100
TRAJECTORY_BUILDER_3D_ESKF.eskf.initial_x = 0.0
