...
TRAJECTORY_BUILDER_3D_ESKF.voxel_filter_size = 0.2
TRAJECTORY_BUILDER_3D_ESKF.submaps.high_resolution = 0.1
TRAJECTORY_BUILDER_3D_ESKF.submaps.low_resolution = 0.3
TRAJECTORY_BUILDER_3D_ESKF.submaps.num_range_data = 30
TRAJECTORY_BUILDER_3D_ESKF.submaps.initial_map_file_name = "/home/aeroscout/Documents/nsh_out_aria/carto.bt"
TRAJECTORY_BUILDER_3D_ESKF.submaps.initial_map_resolution = 0.3
TRAJECTORY_BUILDER_3D_ESKF.submaps.distance_map_range = 40.0
TRAJECTORY_BUILDER_3D_ESKF.eskf.initial_yaw = -0.8378;
