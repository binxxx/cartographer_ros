...
TRAJECTORY_BUILDER_3D_ESKF.submaps.initial_map_file_name = "/home/aeroscout/Documents/highbay_carto/aria_test.bt"
TRAJECTORY_BUILDER_3D_ESKF.submaps.initial_map_resolution = 0.2
TRAJECTORY_BUILDER_3D_ESKF.submaps.distance_map_range = 20.0
TRAJECTORY_BUILDER_3D_ESKF.eskf.initial_yaw = 0.0
TRAJECTORY_BUILDER_3D_ESKF.eskf.sigma_accelerometer = 1.0
TRAJECTORY_BUILDER_3D_ESKF.eskf.sigma_gyroscope = 0.01
