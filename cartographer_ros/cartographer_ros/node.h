...
class Node {
 public:
  ...
  void HandleImageMessage(const int trajectory_id,
 ...
 private:
  ...
  void PublishOctomap(const ::ros::WallTimerEvent& timer_event);
  void PublishSubmapTf(const ::ros::WallTimerEvent& timer_event);
  void PublishPose(const ::ros::WallTimerEvent& timer_event);
  void PublishMapPointCloud(const ::ros::WallTimerEvent& timer_event);
  ...
  ::ros::Publisher boundingbox_publisher_;
  ...
  std::shared_ptr<::octomap::OcTree> matching_octomap_ = nullptr;
  Eigen::Vector3d map_to_local_translation_;
  Eigen::Quaterniond map_to_local_rotation_ = Eigen::Quaterniond::Identity();
};
